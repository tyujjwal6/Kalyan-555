...
const BidHistory = () => {
  ...
  // This single handler works for all inputs, including the new DatePicker
  ...
  const handleSubmit = (e) => {
    ...
    // Format the date object into a string for the "API call"
    const apiFilters = {
      ...filters,
        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
              ...
              <div>
                <Label className="text-sm font-medium text-transparent select-none">.</Label> {/* Spacer label for alignment */}
