                ...
                <TableBody>
                  {predictionResults.length > 0 ? (
                    predictionResults.map((result, index) => (
                      <TableRow key={result.bidTxId} onClick={() => handleRowClick(result)} className="cursor-pointer hover:bg-gray-100">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          {selectedPrediction && (
            <div className="grid gap-2 py-4 text-sm">
              ...
              <div className="flex justify-between"><span className="text-muted-foreground">Winning Amount:</span> <span className="font-medium text-green-600">₹{selectedPrediction.winningAmount}</span></div>
...
export default GameWinningPrediction;